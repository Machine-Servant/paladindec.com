...
import { CardUncheckedUpdateManyWithoutSetInput } from '../card/card-unchecked-update-many-without-set.input';

@InputType()
export class SetUncheckedUpdateInput {
  ...
  @Field(() => CardUncheckedUpdateManyWithoutSetInput, { nullable: true })
  cards?: CardUncheckedUpdateManyWithoutSetInput;
}
