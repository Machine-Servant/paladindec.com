...
import { ScryfallCardCreateNestedOneWithoutCardFacesInput } from '../scryfall-card/scryfall-card-create-nested-one-without-card-faces.input';
...
@InputType()
export class ScryfallCardFaceCreateInput {

    @Field(() => String, {nullable:true})
    id?: string;

    @Field(() => ScryfallCardCreateNestedOneWithoutCardFacesInput, {nullable:false})
    card!: ScryfallCardCreateNestedOneWithoutCardFacesInput;
