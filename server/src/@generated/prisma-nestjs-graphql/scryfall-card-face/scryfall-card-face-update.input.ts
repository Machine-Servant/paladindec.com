...
import { ScryfallCardUpdateOneRequiredWithoutCardFacesInput } from '../scryfall-card/scryfall-card-update-one-required-without-card-faces.input';
...
@InputType()
export class ScryfallCardFaceUpdateInput {

    @Field(() => StringFieldUpdateOperationsInput, {nullable:true})
    id?: StringFieldUpdateOperationsInput;

    @Field(() => ScryfallCardUpdateOneRequiredWithoutCardFacesInput, {nullable:true})
    card?: ScryfallCardUpdateOneRequiredWithoutCardFacesInput;
