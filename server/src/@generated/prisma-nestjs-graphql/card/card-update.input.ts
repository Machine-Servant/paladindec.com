...
import { SetUpdateOneRequiredWithoutCardsInput } from '../set/set-update-one-required-without-cards.input';
import { RelatedCardUpdateManyWithoutCardInput } from '../related-card/related-card-update-many-without-card.input';
import { RelatedCardUpdateManyWithoutReferenceInput } from '../related-card/related-card-update-many-without-reference.input';
import { CardFaceUpdateManyWithoutCardInput } from '../card-face/card-face-update-many-without-card.input';
...
export class CardUpdateInput {
  ...
  @Field(() => SetUpdateOneRequiredWithoutCardsInput, { nullable: true })
  set?: SetUpdateOneRequiredWithoutCardsInput;

  @Field(() => RelatedCardUpdateManyWithoutCardInput, { nullable: true })
  relatedTo?: RelatedCardUpdateManyWithoutCardInput;

  @Field(() => RelatedCardUpdateManyWithoutReferenceInput, { nullable: true })
  referencedBy?: RelatedCardUpdateManyWithoutReferenceInput;

  @Field(() => CardFaceUpdateManyWithoutCardInput, { nullable: true })
  cardFaces?: CardFaceUpdateManyWithoutCardInput;
}
