...
import { SetCreateNestedOneWithoutCardsInput } from '../set/set-create-nested-one-without-cards.input';
...
@InputType()
export class CardCreateWithoutReferencedByInput {
  ...
  @Field(() => SetCreateNestedOneWithoutCardsInput, { nullable: false })
  set!: SetCreateNestedOneWithoutCardsInput;
