...
import { SetOrderByWithRelationInput } from '../set/set-order-by-with-relation.input';
import { RelatedCardOrderByRelationAggregateInput } from '../related-card/related-card-order-by-relation-aggregate.input';
import { CardFaceOrderByRelationAggregateInput } from '../card-face/card-face-order-by-relation-aggregate.input';
...
export class CardOrderByWithRelationInput {
  ...
  @Field(() => RelatedCardOrderByRelationAggregateInput, { nullable: true })
  relatedTo?: RelatedCardOrderByRelationAggregateInput;

  @Field(() => RelatedCardOrderByRelationAggregateInput, { nullable: true })
  referencedBy?: RelatedCardOrderByRelationAggregateInput;

  @Field(() => CardFaceOrderByRelationAggregateInput, { nullable: true })
  cardFaces?: CardFaceOrderByRelationAggregateInput;
}
