...
import { RelatedCardUncheckedCreateNestedManyWithoutCardInput } from '../related-card/related-card-unchecked-create-nested-many-without-card.input';
import { RelatedCardUncheckedCreateNestedManyWithoutReferenceInput } from '../related-card/related-card-unchecked-create-nested-many-without-reference.input';
import { CardFaceUncheckedCreateNestedManyWithoutCardInput } from '../card-face/card-face-unchecked-create-nested-many-without-card.input';

@InputType()
export class CardUncheckedCreateWithoutSetInput {
  ...
  @Field(() => RelatedCardUncheckedCreateNestedManyWithoutCardInput, {
    nullable: true,
  })
  relatedTo?: RelatedCardUncheckedCreateNestedManyWithoutCardInput;

  @Field(() => RelatedCardUncheckedCreateNestedManyWithoutReferenceInput, {
    nullable: true,
  })
  referencedBy?: RelatedCardUncheckedCreateNestedManyWithoutReferenceInput;

  @Field(() => CardFaceUncheckedCreateNestedManyWithoutCardInput, {
    nullable: true,
  })
  cardFaces?: CardFaceUncheckedCreateNestedManyWithoutCardInput;
}
