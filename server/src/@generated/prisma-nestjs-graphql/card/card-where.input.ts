...
import { SetRelationFilter } from '../set/set-relation-filter.input';
import { RelatedCardListRelationFilter } from '../related-card/related-card-list-relation-filter.input';
import { CardFaceListRelationFilter } from '../card-face/card-face-list-relation-filter.input';
...
export class CardWhereInput {
  ...
  @Field(() => SetRelationFilter, { nullable: true })
  set?: SetRelationFilter;

  @Field(() => StringFilter, { nullable: true })
  setId?: StringFilter;

  @Field(() => RelatedCardListRelationFilter, { nullable: true })
  relatedTo?: RelatedCardListRelationFilter;

  @Field(() => RelatedCardListRelationFilter, { nullable: true })
  referencedBy?: RelatedCardListRelationFilter;

  @Field(() => CardFaceListRelationFilter, { nullable: true })
