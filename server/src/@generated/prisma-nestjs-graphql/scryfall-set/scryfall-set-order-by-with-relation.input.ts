...
import { ScryfallCardOrderByRelationAggregateInput } from '../scryfall-card/scryfall-card-order-by-relation-aggregate.input';
import { HideField } from '@nestjs/graphql';

@InputType()
export class ScryfallSetOrderByWithRelationInput {
    ...
    @Field(() => ScryfallCardOrderByRelationAggregateInput, {nullable:true})
