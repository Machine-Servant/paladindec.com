...
import { ScryfallCardUncheckedUpdateManyWithoutSetInput } from '../scryfall-card/scryfall-card-unchecked-update-many-without-set.input';
import { DateTimeFieldUpdateOperationsInput } from '../prisma/date-time-field-update-operations.input';
import { HideField } from '@nestjs/graphql';

@InputType()
export class ScryfallSetUncheckedUpdateInput {
    ...
    @Field(() => ScryfallCardUncheckedUpdateManyWithoutSetInput, {nullable:true})
    cards?: ScryfallCardUncheckedUpdateManyWithoutSetInput;
