...
import { CardCreateNestedOneWithoutScryfallCardInput } from '../card/card-create-nested-one-without-scryfall-card.input';
...
@InputType()
export class ScryfallCardCreateWithoutScryfallPriceInput {
  ...
  @Field(() => CardCreateNestedOneWithoutScryfallCardInput, { nullable: true })
  card?: CardCreateNestedOneWithoutScryfallCardInput;
  ...
  @Field(() => ScryfallRelatedCardCreateNestedManyWithoutCardInput, {
    nullable: true,
  })
