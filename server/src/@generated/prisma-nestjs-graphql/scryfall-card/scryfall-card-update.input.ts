...
import { ScryfallSetUpdateOneRequiredWithoutCardsInput } from '../scryfall-set/scryfall-set-update-one-required-without-cards.input';
import { CardUpdateOneWithoutScryfallCardInput } from '../card/card-update-one-without-scryfall-card.input';
import { ScryfallCardFaceUpdateManyWithoutCardInput } from '../scryfall-card-face/scryfall-card-face-update-many-without-card.input';
import { ScryfallPriceUpdateManyWithoutCardInput } from '../scryfall-price/scryfall-price-update-many-without-card.input';
import { ScryfallRelatedCardUpdateManyWithoutCardInput } from '../scryfall-related-card/scryfall-related-card-update-many-without-card.input';
import { ScryfallRelatedCardUpdateManyWithoutReferenceInput } from '../scryfall-related-card/scryfall-related-card-update-many-without-reference.input';

@InputType()
export class ScryfallCardUpdateInput {
  ...
  @Field(() => ScryfallSetUpdateOneRequiredWithoutCardsInput, {
    nullable: true,
  })
  set?: ScryfallSetUpdateOneRequiredWithoutCardsInput;

  @Field(() => CardUpdateOneWithoutScryfallCardInput, { nullable: true })
  card?: CardUpdateOneWithoutScryfallCardInput;
