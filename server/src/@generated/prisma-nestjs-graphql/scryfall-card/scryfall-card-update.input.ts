...
import { CardUpdateManyWithoutScryfallCardInput } from '../card/card-update-many-without-scryfall-card.input';
...
export class ScryfallCardUpdateInput {
    ...
    @Field(() => ScryfallSetUpdateOneRequiredWithoutCardsInput, {nullable:true})
