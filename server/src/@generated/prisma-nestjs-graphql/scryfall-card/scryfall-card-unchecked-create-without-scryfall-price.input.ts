...
import { CardUncheckedCreateNestedOneWithoutScryfallCardInput } from '../card/card-unchecked-create-nested-one-without-scryfall-card.input';
...
import { ScryfallRelatedCardUncheckedCreateNestedManyWithoutCardInput } from '../scryfall-related-card/scryfall-related-card-unchecked-create-nested-many-without-card.input';
...
@InputType()
export class ScryfallCardUncheckedCreateWithoutScryfallPriceInput {
  ...
  @Field(() => CardUncheckedCreateNestedOneWithoutScryfallCardInput, {
    nullable: true,
  })
  card?: CardUncheckedCreateNestedOneWithoutScryfallCardInput;
